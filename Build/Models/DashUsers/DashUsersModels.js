...
var DashUsersSchema = new _mongoose.Schema({
  name: {
    type: String,
    required: true
  },
...
DashUsersSchema.statics.EncryptPassword = /*#__PURE__*/function () {
...
DashUsersSchema.statics.ComparePassword = /*#__PURE__*/function () {
...
DashUsersSchema.plugin(_mongooseDelete["default"], {
  deletedAt: true,
  deletedBy: true,
  overrideMethods: true
});

var _default = (0, _mongoose.model)('DashUsers', DashUsersSchema);
